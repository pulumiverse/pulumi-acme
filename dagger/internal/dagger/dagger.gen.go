...
import (
	...
	"dagger/pulumi-acme/internal/querybuilder"
)
...
func (r *Golang) BuildContainer(opts ...GolangBuildContainerOpts) *Container {
...
// Lint the Go project
func (r *Golang) GolangciLint(ctx context.Context, opts ...GolangGolangciLintOpts) (string, error) {
...
// Test the Go project
func (r *Golang) Test(ctx context.Context, opts ...GolangTestOpts) (string, error) {
	if r.test != nil {
		return *r.test, nil
	}
