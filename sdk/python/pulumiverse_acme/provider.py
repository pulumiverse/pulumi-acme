...
@pulumi.type_token("pulumi:providers:acme")
class Provider(pulumi.ProviderResource):
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:acme/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
